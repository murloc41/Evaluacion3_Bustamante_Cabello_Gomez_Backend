...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiProductosBody', function() {
      beforeEach(function() {
        instance = new ApiTejelanas.ApiProductosBody();
      });

      it('should create an instance of ApiProductosBody', function() {
        // TODO: update the code to test ApiProductosBody
        expect(instance).to.be.a(ApiTejelanas.ApiProductosBody);
      });
